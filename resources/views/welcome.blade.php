...
<section id="sobre" class="info-section">
    <div class="container">
        <div class="head-box text-center mb-5">
            <h2>Quem somos</h2>
            <h6 class="text-underline-primary">Clinic-JP é um sistema de gerenciamento de clinicas, que visa acelerar
                processos e controlar as informações.</h6>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-block-overlay text-center mb-5 p-lg-3">
                        ...
                        <p class="px-4">Clinic-JP se preocupa com todos os acessos de usuarios, desde os dispositivos
                            moveis até os computadores mais avançados</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-block-overlay text-center mb-5 p-lg-3">
                        <i class="fa fa-calendar box-circle-solid mt-3 mb-3" aria-hidden="true"></i>
                        <h3>Calendario Médico integrado</h3>
                        <p class="px-4">O Médico possui um calendario totalmente integrado com todas as consultas
                            disponiveis e compromissos no dia. </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-block-overlay text-center mb-5 p-lg-3">
                        ...
                        <h3>Histórico</h3>
                        <p class="px-4">Todos os Médicos e Pacientes conta com seu históricos de consultas, no qual
                            exibe todas as consultas cadastradas na clínica.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-block-overlay text-center p-lg-3">
                        ...
                        <p class="px-4">O Paciente e o Atendente pode marcar consulta com o médico da clinica de acordo
                            com a disponibilidade e horários do médico.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-block-overlay text-center p-lg-3">
                        ...
                        <h3>Informativos</h3>
                        <p class="px-4">Todos os usuarios poderão visualizar todos os informativos da clinica (Consultas
                            Dia, total, mês, ano)</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service-block-overlay text-center p-lg-3">
                        ...
                        <h3>Notificações</h3>
                        <p class="px-4">Notificações são mandadas por e-mail sempre que algo acontece no sistema
                            (Remoção de Consultas, alerta de consultas).</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="head-box text-center mb-5 col-md-12">
                <h2>Equipe</h2>
                <h6 class="text-underline-primary mb-5">Equipe de desenvolvimento e negócios</h6>
            </div>
            <div class="col-md-4 mb-md-0 mb-sm-4">
                <div class="member-box anim-lf t-bottom">
                    <img class="img-fluid" style="height: 357px;width: 331px;" src="{{url('img/thales.jpg')}}" alt="">
                    <div class="overlay-content">
                        <h3 class="text-white ml-3 my-0">Thales Henrique</h3>
                        <p class="text-white ml-3 mb-3">Desenvolvedor</p>
            ...
            <div class="col-md-4 mb-md-0 mb-sm-4">
                <div class="member-box anim-lf t-bottom">
                    <img class="img-fluid" src="https://grafreez.com/wp-content/temp_demos/suffi/img/t-member-02.jpg"
                         alt="">
                    <div class="overlay-content">
                        <h3 class="text-white ml-3 my-0">Filipe Vaz</h3>
                        <p class="text-white ml-3 mb-3">Front-End</p>
                        <span class="socail-l ml-3 mb-3">
			            <a href="#" class="mr-2"><i class="fa fa-facebook box-circle-solid"></i></a>
						<a href="#" class="mr-2"><i class="fa fa-twitter box-circle-solid"></i></a>
						<a href="#"><i class="fa fa-dribbble box-circle-solid"></i></a>
            ...
            <div class="col-md-4 mb-md-0 mb-sm-4">
                <div class="member-box anim-lf t-bottom">
                    <img class="img-fluid" src="https://grafreez.com/wp-content/temp_demos/suffi/img/t-member-03.jpg"
                         alt="">
                    <div class="overlay-content">
                        <h3 class="text-white ml-3 my-0">Matheus Victorino</h3>
