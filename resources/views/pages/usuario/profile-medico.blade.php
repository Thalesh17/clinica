...
@section('content')
            ...
            <div class="box-body" style="padding-bottom: 15px;">
                <div class="col-sm-3"><!--left col-->
                    <div class="text-center">
                        ...
                        <h6>Carregar Foto...</h6>
                        {!! Form::file('image-perfil', ['accept'=>'image/*', 'multiple'=>false, 'id'=>'image-perfil', 'class' => 'text-center center-blox file-upload']) !!}                    </div></hr><br>
                </div>
                <div class="row">
    ...
    <div class="box" style="margin-top: 10px;">
        <fieldset class="fieldset-custom" style="padding: 6px;">
            <a href="{{url('consulta/informativo') }}" style="margin-left: 5px;margin-top: 4px;" class="btn btn-default pull-left btn-flat"><i class="glyphicon glyphicon-remove"></i>&nbsp; Cancelar</a>
