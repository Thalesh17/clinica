...
@section('content')
    ...
    <div class="main-header-custom-2 box box-solid">
        <div class="row" style="">
        ...
        <div class="box-body box-pad">
            ...
            <div class="row mobile">
                ...
                <div class="col-md-4 col-filter">
                    <button style="margin-left: 71px;" class="col-md-4 btn btn-primary btn-flat btn-block  btn-primary-custom" onclick="adicionar();"><i class="glyphicon glyphicon-plus"></i> Adicionar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-no-shadow">
            ...
            <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
                <div class="card-block">
                    {!! Form::open(['action' => ('ConsultaController@index'), 'id' => 'form-avancado', 'method' => 'GET']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="table-consulta">
                                    <thead>
                                    <tr>
                                        <th>Paciente</th>
                                        <th>Médico</th>
