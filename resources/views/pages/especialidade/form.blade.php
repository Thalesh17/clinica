<div class="modal-header">
    ...
    <h4 class="modal-title"> {{ (isset($especialidade)) ? 'Editar' : 'Adicionar' }} Especialidade</h4>
</div>
@if(isset($especialidade))
    {!! Form::model($especialidade, ['action' => ('EspecialidadeController@store'), 'id' => 'form-especialidade']) !!}
@else
    {!! Form::open(['action' => ('EspecialidadeController@store'), 'id' => 'form-especialidade']) !!}
@endif
