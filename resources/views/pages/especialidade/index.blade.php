...
@section('content')
    ...
    <div class="main-header-custom">
        <div class="row" style="">
            <div class="row row-title">
                <div class="col-md-12">
                    <h2 class="box-title" style="color: #777777e3;"><i class="fas fa-briefcase-medical"></i><b>  Especialidade</b></h2>
                </div>
            </div>
        </div>
    ...
    @includeIf('layouts.partials.modal', ['idModal' => 'modal-form-especialidade', 'idContent' => 'content-modal-especialidade'])
@stop

@section('scripts-footer')
    <script type="text/javascript" src="{{ asset('js/app/especialidade.js') }}"></script>
@stop
