<div class="modal-header">
    ...
    <h4 class="modal-title"> {{ (isset($sexo)) ? 'Editar' : 'Adicionar' }} Sexo</h4>
</div>
@if(isset($sexo))
    {!! Form::model($sexo, ['action' => ('SexoController@store'), 'id' => 'form-sexo']) !!}
@else
    {!! Form::open(['action' => ('SexoController@store'), 'id' => 'form-sexo']) !!}
@endif
