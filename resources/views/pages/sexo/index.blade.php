...
@section('content')
    ...
    <div class="main-header-custom">
        <div class="row" style="">
            <div class="row row-title">
                <div class="col-md-12">
                    <h2 class="box-title" style="color: #777777e3;"><i class="fa fa-venus-mars"></i><b>  Sexo</b></h2>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-8 padding-none">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                              <a href="{{url('sexo')}}" class="btn btn-primary btn-flat btn_icon_filter btn-primary-custom marginleft pull-left"><i class="fa fa-eraser"></i></a>
                            </span>
                        </div>
                    </div>
                    {!! Form::close() !!}
    ...
    @includeIf('layouts.partials.modal', ['idModal' => 'modal-form-sexo', 'idContent' => 'content-modal-sexo'])
@stop

@section('scripts-footer')
    <script type="text/javascript" src="{{ asset('js/app/sexo.js') }}"></script>
@stop